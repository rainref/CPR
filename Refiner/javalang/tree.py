...
class ReferenceType(Type):
    attrs = ("arguments", "sub_type","annotation")
...
class Assignment(Expression):
    attrs = ("expressionl", "value", "type","selectors")

class TernaryExpression(Expression):
    attrs = ("condition", "if_true", "if_false","selectors")

class BinaryOperation(Expression):
    attrs = ("operator", "operandl", "operandr","selectors")

class Cast(Expression):
    attrs = ("type", "expression","selectors")
