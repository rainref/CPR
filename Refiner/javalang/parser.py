...
class JavaSyntaxError(JavaParserBaseException):
    def __init__(self, description, at=None,want=None):
...
# ---- Helper methods ----
    ...
    def illegal(self, description, at=None,want=None):
        if not at:
            at = self.tokens.look()
        raise JavaSyntaxError(description, at,want)
...
# -- Types --
    ...
    def parse_type(self):
        ...
        elif self.tokens.look().value=="@":
            java_type = self.parse_annotation_type()
        else:
    ...
    @parse_debug
    def parse_annotation_type(self):
        reference_type = tree.ReferenceType()

        self.accept("@")
        annotation=self.accept(Identifier)
        reference_type.annotation=annotation
