...
from component.encoders.transformer import TransformerEncoderLayer
...
class GGNN_ENC(nn.Module):
    ...
    def __init__(self, opt,args):
        ...
        self.layer = nn.ModuleList(
            [TransformerEncoderLayer(args.emsize,
                                              args.num_head,
                                              args.d_ff,
                                              args.d_k,
                                              args.d_v,
                                              args.trans_drop,
                                              args.max_relative_pos[i],
                                              args.use_neg_dist)
...
#         embedding = prop_state
        ...
        for i_step in range(self.n_steps):
            ...
            tf_out, attn_per_head = self.layer[i_step](prop_state,node_mask)
            prop_state = tf_out
        return prop_state
#         return output
