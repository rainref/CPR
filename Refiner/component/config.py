...
def add_model_args(parser):
    ...
    # Model architecture
    model = parser.add_argument_group('TargetCode Generator')
    model.add_argument('--model_type', type=str, default='transformer',
                       choices=['transformer',"OPT","CodeT5"],
    ...
    model.add_argument('--trans_drop', type=float, default=0.1,
    ...
    optim.add_argument('--dropout_emb', type=float, default=0.1,
                       help='Dropout rate for word embeddings')
    optim.add_argument('--dropout_rnn', type=float, default=0.1,
    ...
    optim.add_argument('--warmup_epochs', type=int, default=0,
                       help='Number of of warmup steps')
    optim.add_argument('--stable_epochs', type=int, default=5,
                       help='Number of of warmup steps')
    optim.add_argument('--STLR_epochs', type=int, default=25,
                       help='Number of of warmup steps')
    optim.add_argument('--STLR_max', type=float, default=0.0001,
                       help='Number of of warmup steps')
    optim.add_argument('--STLR_starting', type=float, default=5e-5,
                       help='Number of of warmup steps')
    optim.add_argument('--STLR_ratio', type=int, default=32,
                       help='Number of of warmup steps')
    optim.add_argument('--STLR_cut', type=float, default=0.1,
                       help='Number of of warmup steps')
...
def override_model_args(old_args, new_args):
    ...
    for p in new_args.keys():
        if p not in old_args:
            old_args[p]=new_args[p]
